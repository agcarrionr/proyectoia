...
public class MenuPrincipal extends JFrame implements ActionListener {
	...
	public static int stock0;	private static final long serialVersionUID = 1L;
	...
	protected void actionPerformedMntmVender(ActionEvent e) {
		GuiBoletaVenta vender=new GuiBoletaVenta();
	...
	protected void actionPerformedMntmObsequios(ActionEvent e) {
		GuiConfiObsequios obsequios=new GuiConfiObsequios();
	...
	protected void actionPerformedMntmAcercadeTienda(ActionEvent e) {
		GuiAcercaTienda acercatienda=new GuiAcercaTienda();
